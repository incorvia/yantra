          ...
          def test_bulk_upsert_steps_updates_existing_records_with_varying_data
            ...
            updates_array = [
              { # Update step 1: immediate enqueue
                ...
                scheduled_execution_time: nil, # Explicitly nil for immediate
              ...
              { # Update step 2: delayed enqueue
                ...
                scheduled_execution_time: delay_time,    # Set future time
                updated_at: time_for_update
              }
            ...
            assert_nil step1_updated.scheduled_execution_time
            ...
            refute_nil step2_updated.scheduled_execution_time
            assert_in_delta delay_time, step2_updated.scheduled_execution_time, 1.second
            ...
            assert_nil step3_reloaded.scheduled_execution_time
