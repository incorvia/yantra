  ...
  module Core
    ...
    class Orchestrator
      ...
      def process_dependents(finished_step_id, finished_step_state)
        direct_dependents = repository.get_step_dependencies(finished_step_id)
        ...
        while queue.any?
          ...
          current_batch.each do |step_id|
            ...
            if current_state == StateMachine::PENDING.to_s
              ...
              # TODO: Optimize using get_step_dependents_multi if available?
              direct_deps = repository.get_step_dependents(step_id)
